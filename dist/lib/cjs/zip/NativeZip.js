        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                for (const entry of this.entries) {
                    ...
                    const dosTime = (0, utils_1.dateToDosTime)(entry.date, this.useLocalTime);
                    const dosDate = (0, utils_1.dateToDosDate)(entry.date, this.useLocalTime);
                    ...
                    if (needsZip64Sizes) {
                        ...
                        q += 2;
                        (0, utils_1.writeUInt64LE)(extra, entry.uncompressedSize, q);
                        q += 8;
                        (0, utils_1.writeUInt64LE)(extra, entry.compressedSize, q);
                        q += 8;
                        localExtra = extra;
                    }
                    ...
                    if (centralNeedsZip64) {
                        ...
                        (0, utils_1.writeUInt64LE)(extra, entry.compressedSize, q);
                        q += 8;
                        (0, utils_1.writeUInt64LE)(extra, entry.localHeaderOffset, q);
                        q += 8;
                        centralExtra = extra;
                    }
                ...
                if (useZip64) {
                    ...
                    pz += 4;
                    (0, utils_1.writeUInt64LE)(zip64Eocd, 44, pz);
                    pz += 8;
                    ...
                    zip64Eocd.writeUInt32LE(0, pz);
                    pz += 4;
                    (0, utils_1.writeUInt64LE)(zip64Eocd, totalEntries, pz);
                    pz += 8;
                    (0, utils_1.writeUInt64LE)(zip64Eocd, totalEntries, pz);
                    pz += 8;
                    (0, utils_1.writeUInt64LE)(zip64Eocd, sizeOfCentralDir, pz);
                    pz += 8;
                    (0, utils_1.writeUInt64LE)(zip64Eocd, startOfCentralDir, pz);
                    pz += 8;
                    ...
                    pl += 4;
                    (0, utils_1.writeUInt64LE)(zip64Locator, offsetAfterCentralDir, pl);
                    pl += 8;
                ...
                (_b = (_a = stream).end) === null || _b === void 0 ? void 0 : _b.call(_a, () => resolve());
            }
            catch (err) {
                reject(err);
            }
